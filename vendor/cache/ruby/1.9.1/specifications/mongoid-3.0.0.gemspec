...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<moped>, ["~> 1.1.1"])
      s.add_runtime_dependency(%q<origin>, ["~> 1.0.3"])
      s.add_development_dependency(%q<mocha>, ["= 0.11"])
      s.add_development_dependency(%q<rspec>, ["~> 2.10"])
      s.add_development_dependency(%q<guard>, ["= 1.2.1"])
      s.add_development_dependency(%q<guard-rspec>, ["~> 0.7"])
    else
      s.add_dependency(%q<activemodel>, ["~> 3.1"])
      s.add_dependency(%q<tzinfo>, ["~> 0.3.22"])
      s.add_dependency(%q<moped>, ["~> 1.1.1"])
      s.add_dependency(%q<origin>, ["~> 1.0.3"])
      s.add_dependency(%q<mocha>, ["= 0.11"])
      s.add_dependency(%q<rspec>, ["~> 2.10"])
      s.add_dependency(%q<guard>, ["= 1.2.1"])
